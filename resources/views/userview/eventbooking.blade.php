...
<body  style="font-family:'Nunito', sans-serif;">
  @include('userlayout.nav')
	<div class="container">
<div class="row">
  <h1 style="color: #f28350; margin-left: 5%;">Find A Good Place to Stay....!!!!</h1>
  <div class="col-sm-12">
  <hr>
<div class="row">
...
@foreach($event as $z)
  ...
  <div class="container mt-5">
        <div class="row" style="border-bottom:1px solid #ccc;">
          <div class="col-md-4 offset-md-1 col-sm-4 text-left justify-content-center">
              <div class="card-body">      
                <img src="/storage/{{$z->imageb}}" class="rounded" width="100%"  alt="">
             </div>
          </div>
          ...
          <div class="col-md-4 offset-md-2 col-sm-4 text-left justify-content-center">
              ...
              <div class="card-body">
                ...
                <p class="card-text">From: {{$z->start_date}}
                </p>
                <p class="card-text">To: {{$z->end_date}}
                </p>
